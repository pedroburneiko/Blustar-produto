  ...
  function showFallback(summary) {
    ...
    var mount = function () {
      ...
      bar.style.cssText = [
        ...
        'background:rgba(20,8,10,0.96)', 'border:1px solid rgba(230,57,70,0.55)',
      ...
      msg.innerHTML = '<strong style="color:#ff9aa2">Algo deu errado ao carregar o workspace.</strong>'
        + '<br><span style="color:rgba(255,255,255,0.6)">Seu trabalho salvo está preservado. Detalhes no console (F12).</span>';
